...
def load_data_client1() -> Dataset:
    ## Load Dataset
    fdf = pd.read_csv('Data/Train Data/frequency_domain_features_train.csv')
    hrn = pd.read_csv('Data/Train Data/heart_rate_non_linear_features_train.csv')
    tdf = pd.read_csv('Data/Train Data/time_domain_features_train.csv')

    train_df = pd.merge(fdf, hrn, on='uuid')
    train_df = pd.merge(train_df, tdf, on='uuid')

    ## Test Data
    tfdf = pd.read_csv('Data/Test Data/frequency_domain_features_test.csv')
    thrn = pd.read_csv('Data/Test Data/heart_rate_non_linear_features_test.csv')
    ttdf = pd.read_csv('Data/Test Data/time_domain_features_test.csv')
